...
namespace Ahjob\Demo\Models\Propel\Base;

use \Exception;
use \PDO;
use Ahjob\Demo\Models\Propel\CommonTypeForPropelQuery as ChildCommonTypeForPropelQuery;
use Ahjob\Demo\Models\Propel\Map\CommonTypeForPropelTableMap;
 ...
 *
 *
 * @package    propel.generator.Ahjob.Demo.Models.Propel.Base
 */
abstract class CommonTypeForPropel implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Ahjob\\Demo\\Models\\Propel\\Map\\CommonTypeForPropelTableMap';
    ...
    /**
     * Initializes internal state of Ahjob\Demo\Models\Propel\Base\CommonTypeForPropel object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Ahjob\Demo\Models\Propel\CommonTypeForPropel The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Ahjob\\Demo\\Models\\Propel\\CommonTypeForPropel'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Ahjob\Demo\Models\Propel\CommonTypeForPropel
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Ahjob\Demo\Models\Propel\CommonTypeForPropel The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Ahjob\Demo\Models\Propel\CommonTypeForPropel (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ahjob\Demo\Models\Propel\CommonTypeForPropel Clone of current object.
     * @throws PropelException
     */
