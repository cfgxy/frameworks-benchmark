...
use \Exception;
use \PDO;
use Ahjob\Demo\Models\Propel\CommonTypeForPropel as ChildCommonTypeForPropel;
...
abstract class CommonTypeForPropelQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Ahjob\Demo\Models\Propel\Base\CommonTypeForPropelQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Ahjob\\Demo\\Models\\Propel\\CommonTypeForPropel', $modelAlias = null)
    {
