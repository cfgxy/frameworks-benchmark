...
namespace App\Models\Propel\Map;

use App\Models\Propel\CommonTypeForPropel;
...
class CommonTypeForPropelTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Models.Propel.Map.CommonTypeForPropelTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Models\\Propel\\CommonTypeForPropel';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Models.Propel.CommonTypeForPropel';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Propel\\CommonTypeForPropel');
        $this->setPackage('App.Models.Propel');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Propel\CommonTypeForPropel) { // it's a model object
